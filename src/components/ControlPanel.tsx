...
//     // set selected in store (Map3D watches this and animates camera)
//     setSelected(id);
//     // clear UI search and sync filters.search so visibleMap uses same search
//     setQuery("");
//     setFilters({ search: "" });
//   }

//   return (
//     <div className="absolute left-4 top-20 z-30 w-72 bg-white/95 p-3 rounded shadow-md">
